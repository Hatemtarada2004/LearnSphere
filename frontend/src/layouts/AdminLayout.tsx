    ...
    <>
      <div className="flex items-center gap-2 px-5 py-5 border-b border-gray-100 dark:border-gray-800">
        ...
        <div>
          ...
          <p className="text-2xs text-gray-500 font-medium">Admin Panel</p>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <span className="badge bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 text-2xs">
              Administrator
            </span>
          </div>
        </div>
